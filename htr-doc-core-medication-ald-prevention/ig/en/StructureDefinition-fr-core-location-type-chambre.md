...
* Examples for this Extension: [Chambre 02 - Pression négative](Location-hopitaltest-infectio-ch02-prsn-ngtv.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.fr.core|current/StructureDefinition/StructureDefinition-fr-core-location-type-chambre.json)
