...
| Type d'activité | *✔*{: .yes } | Permet de définir une catégorie de haut niveau d'une UF. Elle permet par exemple d'indiquer si l'UF propose une hospitalisation complète ou partielle. | [fr-core-vs-organization-type-activite](ValueSet-fr-core-vs-organization-type-activite.html) |
