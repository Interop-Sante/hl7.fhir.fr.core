# FR Core Location Extension - Type de chambre - Guide d'implémentation FR Core v2.2.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-location-type-chambre | *Version*:2.2.0-ballot |
| Active as of 2026-01-22 | *Computable Name*:FRCoreLocationTypeChambreExtension |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "extensible",
          "valueSet" : "https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-location-type-chambre|2.2.0-ballot"
        }
      }
    ]
  }
