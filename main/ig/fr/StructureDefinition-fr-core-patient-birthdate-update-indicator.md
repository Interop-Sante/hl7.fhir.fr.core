...
Extension simple avec le type boolean : Indicateur booléen de mise à jour de la date de naissance
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-core-patient-birthdate-update-indicator.csv), [Excel](../StructureDefinition-fr-core-patient-birthdate-update-indicator.xlsx), [Schematron](../StructureDefinition-fr-core-patient-birthdate-update-indicator.sch) 
