...
* Référence ce Profil: [FR Core Procedure Profile](StructureDefinition-fr-core-procedure.md) and [FR Core Schedule Profile](StructureDefinition-fr-core-schedule.md)
