# FRCoreObservationBodyWeightExample - Guide d'implémentation FR Core v2.2.0
...
Profile: [FR Core Observation Body Weight Profile](StructureDefinition-fr-core-observation-body-weight.md)
