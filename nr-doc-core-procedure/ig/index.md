...
* [ActPriority](http://terminology.hl7.org/7.2.0/CodeSystem-v3-ActPriority.html): [FRCoreProcedurePriorityExtension](StructureDefinition-fr-core-procedure-priority-extension.md)
...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "name" : "FR Core Procedure Difficulty Extension",
    ...
    },
    {
      ...
      "name" : "FR Core Procedure Priority Extension",
    ...
    },
    {
      ...
      "name" : "FR Core Procedure Profile",
    ...
    },
    {
      ...
      "name" : "FR Core ValueSet Procedure code",
