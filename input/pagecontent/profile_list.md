...
{% sql {
    "query" : " select name as Name, Description, Web from Resources WHERE Type = 'StructureDefinition' and Title not like '%Extension%' and (Title like 'FR Core Location%' or Title like 'FR Core Organization%') ",
    "class" : "lines",
    "columns" : [
...
<div style="width: 100%; display: flex"> 
{% sql {
    "query" : " select name as Name, Description, Web from Resources WHERE Type = 'StructureDefinition' and Title not like '%Extension%' and (Title like 'FR Core Patient%' or Title like 'FR Core Encounter%' or Title like 'FR Core Healthcare Service%' or Title like 'FR Core Practitioner%' or Title like 'FR Core Related%') ",
    "class" : "lines",
    "columns" : [
        { "title" : "Titre du profil", "type" : "link", "source" : "Name", "target" : "Web"},
        { "title" : "Description", "type" : "markdown", "source" : "Description"}
