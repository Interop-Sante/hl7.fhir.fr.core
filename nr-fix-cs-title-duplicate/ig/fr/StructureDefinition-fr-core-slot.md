...
Cette structure est dérivée de [Slot](http://hl7.org/fhir/R4/slot.html) 
...
* [FR Core Schedule Profile (https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-schedule|2.2.0)](StructureDefinition-fr-core-schedule.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-core-slot.csv), [Excel](../StructureDefinition-fr-core-slot.xlsx), [Schematron](../StructureDefinition-fr-core-slot.sch) 
