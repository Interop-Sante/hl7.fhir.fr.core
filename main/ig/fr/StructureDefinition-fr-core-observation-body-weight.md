...
Cette structure est dérivée de [observation-bodyweight](http://hl7.org/fhir/R4/bodyweight.html) 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-core-observation-body-weight.csv), [Excel](../StructureDefinition-fr-core-observation-body-weight.xlsx), [Schematron](../StructureDefinition-fr-core-observation-body-weight.sch) 
