...
Cette structure est dérivée de [PractitionerEuCore](http://hl7.eu/fhir/base/2.0.0/StructureDefinition-practitioner-eu-core.html) 
...
* [https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-practitioner-specialty|2.2.0](StructureDefinition-fr-core-practitioner-specialty.md)

**Slices**

Cette structure définit les [slices](http://hl7.org/fhir/R4/profiling.html#slices) suivantes:

* The element 1 is sliced based on the value of Practitioner.meta.profile
...
* The element 1 is sliced based on the value of Practitioner.qualification.code.coding (Closed)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-core-practitioner.csv), [Excel](../StructureDefinition-fr-core-practitioner.xlsx), [Schematron](../StructureDefinition-fr-core-practitioner.sch) 
...
```json
{
  ...
  "abstract" : false,
  "type" : "Practitioner",
  "baseDefinition" : "http://hl7.eu/fhir/base/StructureDefinition/practitioner-eu-core|2.0.0",
