...
Cette structure est dérivée de [observation-bodyheight](http://hl7.org/fhir/R4/bodyheight.html) 
...
* [https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-observation-height-body-position|2.2.0](StructureDefinition-fr-core-observation-height-body-position.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-core-observation-body-height.csv), [Excel](../StructureDefinition-fr-core-observation-body-height.xlsx), [Schematron](../StructureDefinition-fr-core-observation-body-height.sch) 
