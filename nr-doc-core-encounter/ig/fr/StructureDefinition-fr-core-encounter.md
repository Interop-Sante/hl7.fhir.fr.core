...
Obligatoire : 5 éléments(3 éléments obligatoire(s) imbriqué(s))
 Fixe : 1 élément
...
* [FR Core Appointment Profile (https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-appointment|2.2.0)](StructureDefinition-fr-core-appointment.md)
...
* [https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-estimated-discharge-date|2.2.0](StructureDefinition-fr-core-estimated-discharge-date.md)

**Slices**

Cette structure définit les [slices](http://hl7.org/fhir/R4/profiling.html#slices) suivantes:

* The element 1 is sliced based on the value of Encounter.meta.profile
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-core-encounter.csv), [Excel](../StructureDefinition-fr-core-encounter.xlsx), [Schematron](../StructureDefinition-fr-core-encounter.sch) 
