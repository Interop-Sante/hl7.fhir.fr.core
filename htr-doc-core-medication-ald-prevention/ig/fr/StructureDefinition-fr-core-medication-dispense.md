...
## Profil de ressource: FR Core MedicationDispense Profile 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.fr.core|current/StructureDefinition/fr-core-medication-dispense)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-core-medication-dispense.csv), [Excel](../StructureDefinition-fr-core-medication-dispense.xlsx), [Schematron](../StructureDefinition-fr-core-medication-dispense.sch) 
