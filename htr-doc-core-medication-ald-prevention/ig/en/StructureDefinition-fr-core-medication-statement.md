...
## Resource Profile: FR Core MedicationStatement Profile 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.fr.core|current/StructureDefinition/StructureDefinition-fr-core-medication-statement.json)
...
Other representations of profile: [CSV](../StructureDefinition-fr-core-medication-statement.csv), [Excel](../StructureDefinition-fr-core-medication-statement.xlsx), [Schematron](../StructureDefinition-fr-core-medication-statement.sch) 
