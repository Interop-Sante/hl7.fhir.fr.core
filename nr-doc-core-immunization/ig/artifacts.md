...
| [FR Core Immunization Profile](StructureDefinition-fr-core-immunization.md) | FRCoreImmunizationProfile permet de décrire l’administration d’un vaccin.* Il permet également de décrire pourquoi un vaccin n’a pas été réalisé.
 |
...
| [FR Core ValueSet Vaccine code CIS](ValueSet-fr-core-vs-vaccine-code-cis.md) | Codes issus de la Base de Données Publique des Médicaments (BDPM) pour identifier les vaccins par leur code CIS (Code Identifiant de Spécialité). |
