...
Ce ValueSet définit les **canaux techniques** par lesquels les traits d’identité d’un patient ou son INS ont été obtenus, conformément au chapitre 4.3 « Récupération de l’INS » du Référentiel National d’Identitovigilance (RNIV 1 - Principes communs, v2.0, décembre 2024).
