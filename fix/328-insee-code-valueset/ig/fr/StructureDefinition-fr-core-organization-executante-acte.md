...
Extension simple avec le type boolean : Indicateur permettant de définir si une UF peut exécuter des actes
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-core-organization-executante-acte.csv), [Excel](../StructureDefinition-fr-core-organization-executante-acte.xlsx), [Schematron](../StructureDefinition-fr-core-organization-executante-acte.sch) 
