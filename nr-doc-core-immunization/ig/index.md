...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      "reference" : {
        "reference" : "ValueSet/fr-core-vs-vaccine-code-cis"
      },
      "name" : "FR Core ValueSet Vaccine code CIS",
