...
| Active as of 2026-02-26 | *Computable Name*:FRCoreContactPointProfile |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-contact-point-email-type|2.2.0-ballot-2"]
      }]
    },
    {
