# FR Core ValueSet Organization Discipline de prestation - nomenclature SAE - Guide d'implémentation Fr Core v2.2.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-discipline-prestation | *Version*:2.2.0-ballot |
| Active as of 2025-12-02 | *Computable Name*:FRCoreValueSetDisciplinePrestation |
...
* Include tous les codes définis dans [`https://hl7.fr/ig/fhir/core/CodeSystem/fr-core-cs-discipline-prestation`](CodeSystem-fr-core-cs-discipline-prestation.md)version 📦2.2.0-ballot

 

### Expansion

Expansion effectuée en interne basée sur [codesystem FR Core CodeSystem Discipline de prestation - nomenclature SAE v2.2.0-ballot (CodeSystem)](CodeSystem-fr-core-cs-discipline-prestation.md)

Ce jeu de valeur (ValueSet) contient 258 concepts
