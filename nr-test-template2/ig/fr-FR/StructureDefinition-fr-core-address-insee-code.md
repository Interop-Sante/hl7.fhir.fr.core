...
Extension simple avec le type Coding : Extension d'ajout du code insee (5 chiffres) à l'adresse postale. This extension adds the insee code (5 digits) to the address
