...
| [FR Core Procedure Profile](StructureDefinition-fr-core-procedure.md) | FRCoreProcedureProfile est un profil utilisé pour décrire un acte planifié ou réalisé. |
...
| [FR Core Procedure Difficulty Extension](StructureDefinition-fr-core-procedure-difficulty-extension.md) | Extension permettant d’indiquer la difficulté perçue ou mesurée d’un acte. |
| [FR Core Procedure Priority Extension](StructureDefinition-fr-core-procedure-priority-extension.md) | Extension permettant d’indiquer la priorité clinique de l’acte. |
...
| [FR Core ValueSet Procedure code](ValueSet-fr-core-vs-procedure-code.md) | Codes autorisés pour indiquer un acte. Inclut :* Terminologie CCAM
