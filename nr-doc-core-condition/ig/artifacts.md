...
| [FR Core Condition Profile](StructureDefinition-fr-core-condition.md) | FRCoreConditionProfile est un profil utilisé pour décrire un problème du patient (une pathologie par exemple). |
