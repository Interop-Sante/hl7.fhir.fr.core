...
* **FR Core ValueSet Vaccine code CIS**

## ValueSet: FR Core ValueSet Vaccine code CIS 

| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-vaccine-code-cis | *Version*:2.2.0 |
| Active as of 2026-06-22 | *Computable Name*:FRCoreValueSetVaccineCodeCIS |
