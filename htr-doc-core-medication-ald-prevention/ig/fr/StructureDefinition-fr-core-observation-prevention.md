# FR Core Observation Prevention - Guide d'implémentation FR Core v2.2.0

## Profil de ressource: FR Core Observation Prevention 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.fr.core|current/StructureDefinition/fr-core-observation-prevention)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-core-observation-prevention.csv), [Excel](../StructureDefinition-fr-core-observation-prevention.xlsx), [Schematron](../StructureDefinition-fr-core-observation-prevention.sch) 
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-observation-prevention",
  "version" : "2.2.0",
