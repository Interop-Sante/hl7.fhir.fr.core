...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-fr-core-body-structure.html"
      }],
      "reference" : {
        "reference" : "StructureDefinition/fr-core-body-structure"
      },
      "name" : "FR Core BodyStructure Profile",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-fr-core-vs-body-structure-location.html"
      }],
      "reference" : {
        "reference" : "ValueSet/fr-core-vs-body-structure-location"
      },
      "name" : "FR Core ValueSet BodyStructure location",
