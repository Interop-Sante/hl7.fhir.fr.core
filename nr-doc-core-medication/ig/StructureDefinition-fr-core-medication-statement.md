...
* **FR Core MedicationStatement Profile**

## Resource Profile: FR Core MedicationStatement Profile 

| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-medication-statement | *Version*:2.2.0 |
| Active as of 2026-06-22 | *Computable Name*:FRCoreMedicationStatementProfile |
