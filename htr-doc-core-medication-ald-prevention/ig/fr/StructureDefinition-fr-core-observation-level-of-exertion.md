...
Extension simple avec le type CodeableConcept : Extension française définie dans le contexte du profil Vital Signs Resprate. Cette extension permet de préciser le niveau d'exercice du patient durant la mesure de la fréquence respiratoire (au repos, pendant l'effort, après l'effort). French extension defined in the context of the Vital Signs Resprate profile. This extension is used to define the level of exertion ( at rest, during exertion, post exertion) during the respiratory rate measure
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-core-observation-level-of-exertion.csv), [Excel](../StructureDefinition-fr-core-observation-level-of-exertion.xlsx), [Schematron](../StructureDefinition-fr-core-observation-level-of-exertion.sch) 
