...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "StructureDefinition-fr-core-condition.html"
      }],
      "reference" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "Condition-FRCoreConditionExample.html"
      }],
      "reference" : {
        "reference" : "Condition/FRCoreConditionExample"
      },
      "name" : "FRCoreConditionExample",
      "description" : "Exemple de ressource Condition : asthme chronique actif chez un patient identifié par son INS",
      "exampleCanonical" : "https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-condition|2.2.0"
    },
    {
      "extension" : [{
        "url" : "http://hl7.org/fhir/tools/StructureDefinition/resource-information",
