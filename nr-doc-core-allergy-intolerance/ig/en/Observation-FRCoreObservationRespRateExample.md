...
Profile: [FR Core Observation Respiratory Rate Profile](StructureDefinition-fr-core-observation-resp-rate.md)
...
**value**: 16 respirations/minute (Details: UCUM code/min = '/min')
