...
## Exemple Immunization: FRCoreImmunizationExample
...
Profil: [FR Core Immunization Profile](StructureDefinition-fr-core-immunization.md)
...
**doseQuantity**: 0.5 mL (Détails : code UCUMmL = 'mL')
