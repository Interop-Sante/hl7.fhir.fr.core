...
| Active as of 2026-02-26 | *Computable Name*:FRCorePractitionerRoleProfile |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Reference",
        "targetProfile" : ["https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-healthcare-service|2.2.0-ballot-2"]
      }]
    },
    {
