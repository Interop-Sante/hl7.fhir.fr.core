# FRCoreObservationBPExample - Guide d'implémentation FR Core v2.2.0
...
Profile: [FR Core Observation Blood Pressure Profile](StructureDefinition-fr-core-observation-bp.md)
