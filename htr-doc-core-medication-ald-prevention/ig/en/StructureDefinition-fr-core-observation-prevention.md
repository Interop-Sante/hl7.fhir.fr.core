...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.fr.core|current/StructureDefinition/StructureDefinition-fr-core-observation-prevention.json)
...
Other representations of profile: [CSV](../StructureDefinition-fr-core-observation-prevention.csv), [Excel](../StructureDefinition-fr-core-observation-prevention.xlsx), [Schematron](../StructureDefinition-fr-core-observation-prevention.sch) 
