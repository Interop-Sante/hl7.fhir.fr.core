...
| Active as of 2026-03-20 | *Computable Name*:FRCorePatientProfile |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-patient-contact-relationship-category|2.2.0-ballot-2"]
      }]
    },
    {
