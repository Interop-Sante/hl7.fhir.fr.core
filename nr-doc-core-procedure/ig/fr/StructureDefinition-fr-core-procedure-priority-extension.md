...
Extension simple avec le type CodeableConcept : Extension permettant d'indiquer la priorité clinique de l'acte.
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-core-procedure-priority-extension.csv), [Excel](../StructureDefinition-fr-core-procedure-priority-extension.xlsx), [Schematron](../StructureDefinition-fr-core-procedure-priority-extension.sch) 
