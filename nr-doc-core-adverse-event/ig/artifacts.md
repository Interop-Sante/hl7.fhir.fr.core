...
| | |
| :--- | :--- |
| [FR Core AdverseEvent Profile](StructureDefinition-fr-core-adverse-event.md) | FRCoreAdverseEventProfile permet de décrire un effet indésirable prévisible lié à un médicament |
