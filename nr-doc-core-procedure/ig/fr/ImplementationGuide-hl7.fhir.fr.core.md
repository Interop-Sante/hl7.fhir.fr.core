...
```json
{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-fr-core-vs-procedure-code-autre.html"
      }],
      "reference" : {
        "reference" : "ValueSet/fr-core-vs-procedure-code-autre"
      },
      "name" : "FR Core ValueSet Procedure code - Autre acte",
    ...
    },
    {
      ...
      {
        "url" : "http://hl7.org/fhir/StructureDefinition/implementationguide-page",
        "valueUri" : "ValueSet-fr-core-vs-procedure-code-snomed.html"
      }],
      "reference" : {
        "reference" : "ValueSet/fr-core-vs-procedure-code-snomed"
      },
      "name" : "FR Core ValueSet Procedure code - SNOMED CT",
