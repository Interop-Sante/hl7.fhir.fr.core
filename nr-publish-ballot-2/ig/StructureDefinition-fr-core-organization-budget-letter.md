# FR Core Organization Budget Letter Extension - Guide d'implémentation FR Core v2.2.0-ballot-2
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-organization-budget-letter | *Version*:2.2.0-ballot-2 |
| Active as of 2026-01-28 | *Computable Name*:FRCoreOrganizationBudgetLetterExtension |
...
* Utiliser ce Extension: [FR Core Organization Pole Profile](StructureDefinition-fr-core-organization-pole.md) and [FR Core Organization UF Profile](StructureDefinition-fr-core-organization-uf.md)
