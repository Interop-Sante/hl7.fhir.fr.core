...
* [ActCode](http://terminology.hl7.org/7.2.0/CodeSystem-v3-ActCode.html): [Encounter/FRCoreEncounterExample](Encounter-FRCoreEncounterExample.md), [FRCoreEncounterProfile](StructureDefinition-fr-core-encounter.md) and [FRCoreValueSetEncounterClass](ValueSet-fr-core-vs-encounter-class.md)
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-06-22T08:46:02+00:00",
