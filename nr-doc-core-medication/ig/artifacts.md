...
| [FR Core Medication Profile](StructureDefinition-fr-core-medication.md) | FRCoreMedicationProfile permet de décrire un médicament ou un vaccin. |
| [FR Core MedicationAdministration Profile](StructureDefinition-fr-core-medication-administration.md) | FRCoreMedicationAdministrationProfile permet de décrire les modalités d’administration d’un médicament au patient (médicament, mode d’administration, quantité, durée et fréquence). |
| [FR Core MedicationDispense Profile](StructureDefinition-fr-core-medication-dispense.md) | FRCoreMedicationDispenseProfile permet de décrire un traitement dispensé avec notamment le médicament dispensé, la quantité et la référence de la prescription. |
| [FR Core MedicationRequest Profile](StructureDefinition-fr-core-medication-request.md) | FRCoreMedicationRequestProfile permet de décrire un traitement prescrit avec notamment le médicament, le mode d’administration, la quantité, la durée et la fréquence d’administration. |
| [FR Core MedicationStatement Profile](StructureDefinition-fr-core-medication-statement.md) | FRCoreMedicationStatementProfile permet de décrire les modalités d’administration d’un médicament au patient (médicament déclaré, mode d’administration, quantité, durée et fréquence). Couvre les bilans médicamenteux et conciliations médicamenteuses. |
...
| [FR Core Medication Administration Sequence Extension](StructureDefinition-fr-core-medication-administration-sequence.md) | Extension permettant d’indiquer l’ordre d’une prise dans le cadre d’un schéma de traitement comportant des dosages progressifs ou fractionnés dans le contexte de MedicationAdministration. |
| [FR Core MedicationRequest Treatment Intent Extension](StructureDefinition-fr-core-treatment-intent.md) | Intention globale du traitement. |
| [FR Core Not Covered Extension](StructureDefinition-fr-core-not-covered.md) | Extension permettant d’indiquer si le traitement est non remboursable. |
...
| [FR Core ValueSet EDQM](ValueSet-fr-core-vs-edqm.md) | Formes galéniques issues du CodeSystem EDQM fourni par le SMT (classe PDF). |
...
| [FR Core ValueSet Medication translation](ValueSet-fr-core-vs-medication-translation.md) | Systèmes de codification autorisés pour les médicaments : CIP, UCD, ATC, MV (médicament virtuel) et NUVA (vaccins). |
...
| [FR Core ValueSet Treatment Intent](ValueSet-fr-core-vs-treatment-intent.md) | Jeu de valeurs SNOMED CT pour l’intention globale du traitement (MedicationRequest). |
...
| [FRCoreMedicationAdministrationInhaledOxygenExample](MedicationAdministration-FRCoreMedicationAdministrationInhaledOxygenExample.md) | Exemple de ressource MedicationAdministration pour décrire l’administration d’oxygène inhalé |
...
| [FRCoreObservationOxygenSaturationExample](Observation-FRCoreObservationOxygenSaturationExample.md) | Exemple de ressource Observation pour décrire la saturation en oxygène d’un patient sous oxygénothérapie |
