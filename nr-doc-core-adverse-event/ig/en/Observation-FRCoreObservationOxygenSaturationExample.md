...
Profile: [FR Core Observation Oxygen Saturation Profile](StructureDefinition-fr-core-observation-saturation-oxygen.md)

**partOf**: [MedicationAdministration: status = in-progress; medication[x] = produit contenant de l'oxygène; effective[x] = 2022-11-06 09:00:00+0100 --> (ongoing)](MedicationAdministration-FRCoreMedicationAdministrationInhaledOxygenExample.md)
